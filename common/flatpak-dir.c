...
#define SYSCONF_PREINSTALL_DIR "preinstall.d"
#define SYSCONF_PREINSTALL_FILE_EXT ".preinstall"
  ...
  while (TRUE)
    {
      ...
      if (type == G_FILE_TYPE_REGULAR && g_str_has_suffix (name, SYSCONF_PREINSTALL_FILE_EXT))
        {
          g_autofree char *path_str = g_file_get_path (path);
